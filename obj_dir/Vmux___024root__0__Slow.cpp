...
#endif
            VL_FATAL_MT("mux_tb.v", 3, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 100 tries");
        }
...
VL_ATTR_COLD void Vmux___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @( mux_tb.a)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 1U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 1 is active: @( mux_tb.b)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 2U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 2 is active: @( mux_tb.c)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 3U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 3 is active: @( mux_tb.d)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 4U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 4 is active: @( mux_tb.out)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 5U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 5 is active: @( mux_tb.sel)\n");
    }
...
VL_ATTR_COLD void Vmux___024root___ctor_var_reset(Vmux___024root* vlSelf) {
    ...
    vlSelf->mux_tb__DOT__a = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 17102636397944252413ull);
    vlSelf->mux_tb__DOT__b = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 11232451631118099095ull);
    vlSelf->mux_tb__DOT__c = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 5535439822917821584ull);
    vlSelf->mux_tb__DOT__d = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 10809189127340443509ull);
    vlSelf->mux_tb__DOT__sel = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 4375133214016442974ull);
    vlSelf->mux_tb__DOT__out = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 16451029987426916148ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP__mux_tb__DOT__a__0 = 0;
    vlSelf->__Vtrigprevexpr___TOP__mux_tb__DOT__b__0 = 0;
    vlSelf->__Vtrigprevexpr___TOP__mux_tb__DOT__c__0 = 0;
    vlSelf->__Vtrigprevexpr___TOP__mux_tb__DOT__d__0 = 0;
    vlSelf->__Vtrigprevexpr___TOP__mux_tb__DOT__out__0 = 0;
    vlSelf->__Vtrigprevexpr___TOP__mux_tb__DOT__sel__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
